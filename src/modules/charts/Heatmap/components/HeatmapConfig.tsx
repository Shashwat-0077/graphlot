...
export const HeatmapConfig: ChartConfigComponentType = () => {
    ...
    return (
        ...
        //     <div
        //         className="cursor-pointer rounded border px-5 py-5"
        //         onClick={() => {
        //             toggleStreak();
        //         }}
        //     >
        ...
        //     >
        //         <div className="flex items-center">
        //             <Checkbox className="mr-3" checked={longestStreak.show} />
        ...
        //     >
        //         <div className="flex items-center">
        //             <Checkbox className="mr-3" checked={numberOfEntries.show} />
