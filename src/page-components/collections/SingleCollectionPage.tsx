...
import { ChartCard } from "@/modules/chart-attributes/components/chart-card";
            ...
            <div className="bg-background/60 mb-8 rounded-xl border p-6 shadow-sm backdrop-blur-sm">
                <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        {isCollectionLoading ? (
                            <div className="bg-muted mt-2 h-5 w-72 animate-pulse rounded-md"></div>
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                        ...
                        <Card className="border-muted bg-background/50">
                            <CardContent className="flex items-center justify-between p-4">
                                ...
                                <Layers className="text-primary/40 h-8 w-8" />
                            </CardContent>
                        </Card>
                        <Card className="border-muted bg-background/50">
                            <CardContent className="flex items-center justify-between p-4">
