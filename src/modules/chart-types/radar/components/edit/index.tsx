...
import { ColorsSettings } from "@/modules/chart-types/radar/components/edit/color-settings";
import { GridAndBoxModelSettings } from "@/modules/chart-types/radar/components/edit/grid-and-box-model-settings";
import { TypographyAndStyleSettings } from "@/modules/chart-types/radar/components/edit/typography-and-style-settings";

export function RadarConfigTabs() {
    return (
