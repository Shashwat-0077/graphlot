...
} from '@/modules/radar/default-radar-config';
...
export const RadarCharts = sqliteTable(RADAR_CHARTS_TABLE_NAME, {
    ...
    xAxisField: text('x_axis_field').notNull().default(defaultRadarChartConfig.xAxisField),
    yAxisField: text('y_axis_field').notNull().default(defaultRadarChartConfig.yAxisField),
    xAxisSortOrder: text('x_sort_order').notNull().default(defaultRadarChartConfig.xAxisSortOrder).$type<SortType>(),
    yAxisSortOrder: text('y_sort_order').notNull().default(defaultRadarChartConfig.yAxisSortOrder).$type<SortType>(),
