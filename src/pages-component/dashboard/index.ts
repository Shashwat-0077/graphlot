...
// import { BarChart2, GroupIcon as CollectionIcon, Plus, ChevronRight, Calendar, LayoutDashboard } from 'lucide-react';
// import {
//     Line,
//     LineChart,
//     Pie,
...
//                     <h1 className="text-xl font-semibold text-red-800">Unable to load dashboard</h1>
//                     <p className="mt-2 text-red-700">Failed to load collections. Please try again later.</p>
//                 </div>
//             </div>
//         );
//     }
...
//     const totalCharts = collections.reduce((sum, collection) => sum + collection.chartCount, 0);
...
//                             <div>
//                                 <div className="pb-2 text-sm font-medium text-muted-foreground">Collections</div>
//                                 <div>
//                                     <div className="text-3xl font-bold">{collections.length}</div>
//                                     <p className="text-xs text-muted-foreground">
//                                         {collections.length > 0 &&
//                                             `Last updated ${formatRelativeTime(
//                                                 collections.reduce((latest, col) => Math.max(latest, col.updatedAt), 0),
//                                             )}`}
//                                     </p>
//                                 </div>
//                             </div>
...
//                         <div className="flex items-center justify-between">
//                             <div>
//                                 <div className="pb-2 text-sm font-medium text-muted-foreground">Total Charts</div>
//                                 <div>
//                                     <div className="text-3xl font-bold">{totalCharts}</div>
//                                     <p className="text-xs text-muted-foreground">
//                                         {collections.length > 0 &&
//                                             `Across ${collections.length} collection${
...
//                         <div className="flex items-center justify-between">
//                             <div>
//                                 <div className="pb-2 text-sm font-medium text-muted-foreground">Last Activity</div>
//                                 <div>
//                                     <div className="text-3xl font-bold">
//                                         {collections.length > 0
//                                             ? formatRelativeTime(
//                                                   collections.reduce(
//                                                       (latest, col) => Math.max(latest, col.updatedAt),
//                                                       0,
//                                                   ),
//                                               ).split(' ')[0]
//                                             : '0'}
...
//                         <CardDescription>Monthly chart creation trend</CardDescription>
//                     </CardHeader>
//                     <CardContent>
//                         {collections.length === 0 ? (
...
//                                     Create your first collection to start tracking chart growth
//                                 </p>
//                             </div>
//                         ) : (
...
//                                 <CardDescription>Manage and organize your chart collections</CardDescription>
//                             </div>
//                             <Button
//                                 asChild
//                                 variant="outline"
...
//                                 <p className="mt-2 text-sm text-muted-foreground">
//                                     Create your first collection to start organizing your charts
//                                 </p>
//                                 <Button
//                                     asChild
...
//                                             href={`/dashboard/collections/${collection.collectionId}-${collection.name
//                                                 .toLowerCase()
//                                                 .replace(/\s+/g, '-')}`}
...
//                                                         {collection.chartCount} chart
//                                                         {collection.chartCount !== 1 ? 's' : ''}
//                                                     </p>
//                                                 </div>
//                                             </div>
