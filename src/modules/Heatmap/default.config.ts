...
const defaultHeatmapChartConfig = {
    ...
    metric: "count",
    streak: 0,
    streak_color: { r: 255, g: 255, b: 255, a: 1 } as RGBAColor,
    streak_enabled: true,
    ...
    longest_streak: 0,
    longest_streak_color: { r: 255, g: 255, b: 255, a: 1 } as RGBAColor,
    longest_streak_enabled: true,
    sum_of_all_entries: 0,
    sum_of_all_entries_color: { r: 255, g: 255, b: 255, a: 1 } as RGBAColor,
    sum_of_all_entries_enabled: true,
    average_of_all_entries: 0,
    average_of_all_entries_color: { r: 255, g: 255, b: 255, a: 1 } as RGBAColor,
    average_of_all_entries_enabled: true,
    number_of_entries: 0,
    number_of_entries_color: { r: 255, g: 255, b: 255, a: 1 } as RGBAColor,
    number_of_entries_enabled: true,
    button_hover_enabled: false,
    default_box_color: { r: 38, g: 38, b: 38, a: 1 } as RGBAColor,
    accent: { r: 255, g: 255, b: 255, a: 1 } as RGBAColor,
};
