...
import { Database, Grid2X2 } from "lucide-react";
...
export function HeatmapDataSettings({
    chartId,
    userId,
}: {
    chartId: string;
    ...
    const dataField = useHeatmapStore((state) => state.dateField);
    const valueField = useHeatmapStore((state) => state.valueField);
