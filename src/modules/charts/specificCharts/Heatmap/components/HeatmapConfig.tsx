...
import { DayOfWeek } from "@/modules/charts/specificCharts/Heatmap/state/store/appearance-store";
            ...
            <div className="grid-row-2 grid grid-cols-4 rounded border">
                ...
                >
                    <div
                        className="grid cursor-pointer border py-7"
                        style={{
                            backgroundColor: `rgba(${defaultBoxColor.r}, ${defaultBoxColor.g}, ${defaultBoxColor.b})`,
                        }}
                    />
                </ColorPickerPopover>
