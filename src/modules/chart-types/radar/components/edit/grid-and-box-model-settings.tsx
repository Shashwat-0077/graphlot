...
function GridToggleSetting() {
    const gridEnabled = useRadarChartStore((s) => s.gridEnabled);
    const setVisuals = useRadarChartStore((s) => s.setVisuals);
...
function GridOrientationSetting() {
    const gridOrientation = useRadarChartStore((s) => s.gridOrientation);
    const gridEnabled = useRadarChartStore((s) => s.gridEnabled);
    const setVisuals = useRadarChartStore((s) => s.setVisuals);
...
function GridStyleSetting() {
    const gridStyle = useRadarChartStore((s) => s.gridStyle);
    const gridEnabled = useRadarChartStore((s) => s.gridEnabled);
    const setVisuals = useRadarChartStore((s) => s.setVisuals);
...
function GridWidthSetting() {
    const gridWidth = useRadarChartStore((s) => s.gridWidth);
    const setVisuals = useRadarChartStore((s) => s.setVisuals);
    const gridEnabled = useRadarChartStore((s) => s.gridEnabled);
...
function TooltipEnableToggle() {
    const tooltipEnabled = useRadarChartStore((s) => s.tooltipEnabled);
    const setVisuals = useRadarChartStore((s) => s.setVisuals);
...
function TooltipStyleSetting() {
    const tooltipStyle = useRadarChartStore((s) => s.tooltipStyle);
    const setVisuals = useRadarChartStore((s) => s.setVisuals);
    const tooltipEnabled = useRadarChartStore((s) => s.tooltipEnabled);
...
function TooltipBorderWidthSetting() {
    const tooltipBorderWidth = useRadarChartStore((s) => s.tooltipBorderWidth);
    const setVisuals = useRadarChartStore((s) => s.setVisuals);
    const tooltipEnabled = useRadarChartStore((s) => s.tooltipEnabled);
...
function BorderWidthSetting() {
    const borderWidth = useRadarChartStore((s) => s.borderWidth);
    const setBoxModel = useRadarChartStore((s) => s.setBoxModel);
...
function MarginTopInput() {
    const marginTop = useRadarChartStore((s) => s.marginTop);
    const setBoxModel = useRadarChartStore((s) => s.setBoxModel);
...
function MarginBottomInput() {
    const marginBottom = useRadarChartStore((s) => s.marginBottom);
    const setBoxModel = useRadarChartStore((s) => s.setBoxModel);
...
function MarginLeftInput() {
    const marginLeft = useRadarChartStore((s) => s.marginLeft);
    const setBoxModel = useRadarChartStore((s) => s.setBoxModel);
...
function MarginRightInput() {
    const marginRight = useRadarChartStore((s) => s.marginRight);
    const setBoxModel = useRadarChartStore((s) => s.setBoxModel);
...
function XOffsetSettings() {
    const xOffset = useRadarChartStore((s) => s.xOffset);
    const setBoxModel = useRadarChartStore((s) => s.setBoxModel);
...
function YOffsetSettings() {
    const yOffset = useRadarChartStore((s) => s.yOffset);
    const setBoxModel = useRadarChartStore((s) => s.setBoxModel);
