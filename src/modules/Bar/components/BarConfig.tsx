...
function Colors({
    ...
    text_color: BarSelect["text_color"];
    background_color: BarSelect["background_color"];
    grid_color: BarSelect["grid_color"];
    color_palette: BarSelect["color_palette"];
    setTextColor: (color: BarSelect["text_color"]) => void;
    setBackgroundColor: (color: BarSelect["background_color"]) => void;
    setGridColor: (color: BarSelect["grid_color"]) => void;
    addColor: () => void;
    removeColor: (index: number) => void;
    clearColorPalette: () => void;
    updateColor: (color: BarSelect["color_palette"][0], index: number) => void;
}) {
    return (
...
const GridAndLayout = ({
    ...
    grid_type: BarSelect["grid_type"];
    setGridType: (grid_type: BarSelect["grid_type"]) => void;
}) => {
    return (
        <div className="space-y-5 p-2">
            <div className="mb-3 flex items-center gap-2">
...
export const BarConfig: ChartConfigComponentType = ({
    notion_table_id,
    chart_id,
}) => {
    ...
    const onApply = () => {
        ...
        setGlobalOmitZeroValues(cumulative);
        setGlobalCumulative(omitZeroValues);
    };
