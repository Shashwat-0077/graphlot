...
import { FilterType } from "@/modules/charts/specificCharts/Bar/state/store/config-store";
import {
    useBarChartAppearanceStore,
    useBarChartConfigStore,
} from "@/modules/charts/specificCharts/Bar/state/provider/bar-chart-store-provider";
