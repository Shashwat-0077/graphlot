...
function GridToggleSetting() {
    const gridEnabled = useBarChartStore((s) => s.gridEnabled);
    const setVisuals = useBarChartStore((s) => s.setVisuals);
...
function GridOrientationSetting() {
    const gridOrientation = useBarChartStore((s) => s.gridOrientation);
    const gridEnabled = useBarChartStore((s) => s.gridEnabled);
    const setVisuals = useBarChartStore((s) => s.setVisuals);
...
function GridStyleSetting() {
    const gridStyle = useBarChartStore((s) => s.gridStyle);
    const gridEnabled = useBarChartStore((s) => s.gridEnabled);
    const setVisuals = useBarChartStore((s) => s.setVisuals);
...
function GridWidthSetting() {
    const gridWidth = useBarChartStore((s) => s.gridWidth);
    const setVisuals = useBarChartStore((s) => s.setVisuals);
    const gridEnabled = useBarChartStore((s) => s.gridEnabled);
...
function TooltipEnableToggle() {
    const tooltipEnabled = useBarChartStore((s) => s.tooltipEnabled);
    const setVisuals = useBarChartStore((s) => s.setVisuals);
...
function TooltipStyleSetting() {
    const tooltipStyle = useBarChartStore((s) => s.tooltipStyle);
    const setVisuals = useBarChartStore((s) => s.setVisuals);
    const tooltipEnabled = useBarChartStore((s) => s.tooltipEnabled);
...
function TooltipBorderWidthSetting() {
    const tooltipBorderWidth = useBarChartStore((s) => s.tooltipBorderWidth);
    const setVisuals = useBarChartStore((s) => s.setVisuals);
    const tooltipEnabled = useBarChartStore((s) => s.tooltipEnabled);
...
function TooltipBorderRadiusSetting() {
    const tooltipBorderRadius = useBarChartStore((s) => s.tooltipBorderRadius);
    const setVisuals = useBarChartStore((s) => s.setVisuals);
    const tooltipEnabled = useBarChartStore((s) => s.tooltipEnabled);
...
function TooltipTotalToggle() {
    const tooltipTotalEnabled = useBarChartStore((s) => s.tooltipTotalEnabled);
    const setVisuals = useBarChartStore((s) => s.setVisuals);
    const tooltipEnabled = useBarChartStore((s) => s.tooltipEnabled);
...
function BorderWidthSetting() {
    const borderWidth = useBarChartStore((s) => s.borderWidth);
    const setBoxModel = useBarChartStore((s) => s.setBoxModel);
...
function MarginTopInput() {
    const marginTop = useBarChartStore((s) => s.marginTop);
    const setBoxModel = useBarChartStore((s) => s.setBoxModel);
...
function MarginBottomInput() {
    const marginBottom = useBarChartStore((s) => s.marginBottom);
    const setBoxModel = useBarChartStore((s) => s.setBoxModel);
...
function MarginLeftInput() {
    const marginLeft = useBarChartStore((s) => s.marginLeft);
    const setBoxModel = useBarChartStore((s) => s.setBoxModel);
...
function MarginRightInput() {
    const marginRight = useBarChartStore((s) => s.marginRight);
    const setBoxModel = useBarChartStore((s) => s.setBoxModel);
