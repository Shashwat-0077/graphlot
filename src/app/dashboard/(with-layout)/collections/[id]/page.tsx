...
import { getAllChartsWithCollectionId } from "@/features/charts/api/getCharts";
        ...
        <div className="grid grid-cols-1 gap-x-5 gap-y-5 pb-7 break900:grid-cols-2 break1200:grid-cols-3">
            {charts.map((chart) => (
                <ChartCard
                    ...
                    notionDatabaseName="Products" // TODO : Fetch the notion database name from the database
                />
            ))}
