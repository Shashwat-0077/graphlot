...
} from '@/modules/area/default-area-config';
...
export const AreaCharts = sqliteTable(AREA_CHARTS_TABLE_NAME, {
    ...
    xAxisField: text('x_axis_field').notNull().default(defaultAreaChartConfig.xAxisField),
    yAxisField: text('y_axis_field').notNull().default(defaultAreaChartConfig.yAxisField),
    xAxisSortOrder: text('x_sort_order').notNull().default(defaultAreaChartConfig.xAxisSortOrder).$type<SortType>(),
    yAxisSortOrder: text('y_sort_order').notNull().default(defaultAreaChartConfig.yAxisSortOrder).$type<SortType>(),
