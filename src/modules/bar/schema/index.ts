...
import { BarSpecificConfig, barSpecificConfigDefaults, defaultBarChartConfig } from '@/modules/bar/default-bar-config';
...
export const BarCharts = sqliteTable(BAR_CHARTS_TABLE_NAME, {
    ...
    xAxisField: text('x_axis_field').notNull().default(defaultBarChartConfig.xAxisField),
    yAxisField: text('y_axis_field').notNull().default(defaultBarChartConfig.yAxisField),
    xAxisSortOrder: text('x_sort_order').notNull().default(defaultBarChartConfig.xAxisSortOrder).$type<SortType>(),
    yAxisSortOrder: text('y_sort_order').notNull().default(defaultBarChartConfig.yAxisSortOrder).$type<SortType>(),
