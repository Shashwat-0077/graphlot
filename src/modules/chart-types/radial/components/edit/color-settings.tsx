...
function BackGroundColor() {
    ...
    const setColor = useRadialChartStore((state) => state.setColor);
...
function GridColor() {
    const gridColor = useRadialChartStore((state) => state.gridColor);
    const setColor = useRadialChartStore((state) => state.setColor);
...
function TrackColor() {
    ...
    const setRadialConfig = useRadialChartStore(
        (state) => state.setRadialConfig
    );

    return (
        <ColorTile
            color={trackColor}
            setColor={(color) => setRadialConfig("trackColor", color)}
            label="Track"
        />
    );
}
