...
import { ChartConfigComponentType } from "@/modules/charts/types";
import { FilterType } from "@/modules/charts/specificCharts/Radar/state/store/config-store";
import {
    useRadarChartAppearanceStore,
    useRadarChartConfigStore,
} from "@/modules/charts/specificCharts/Radar/state/provider/radar-chart-store-provider";
...
export const RadarConfig: ChartConfigComponentType = ({ notion_table_id }) => {
    ...
    } = useRadarChartConfigStore((state) => state);
