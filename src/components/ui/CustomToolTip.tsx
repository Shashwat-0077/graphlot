...
export const CustomTooltipContent = ({
    ...
    return (
        <div
            className={cn(
                "max-w-[280px] overflow-hidden border bg-background p-4 shadow-lg",
        ...
        >
            {indicator === "line" && (
                <div className="absolute -left-px top-0 h-full w-[2px] bg-border" />
            )}
                        ...
                        (
                            ...
                            >
                                <div className="flex min-w-0 items-center gap-2">
                                    ...
                                    />
                                    <span
                                        className="truncate text-sm transition-colors group-hover:text-foreground"
                                        title={entry.name}
                                    >
                                        {entry.name}
                                    </span>
