...
import { ColorsSettings } from "@/modules/chart-types/radial/components/edit/color-settings";
import { GridAndBoxModelSettings } from "@/modules/chart-types/radial/components/edit/grid-and-box-model-settings";
import { TypographyAndStyleSettings } from "@/modules/chart-types/radial/components/edit/typography-and-style-settings";

export function RadialConfigTabs() {
    return (
